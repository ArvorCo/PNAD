...
CARDS: list[dict] = [
    ...
    },
    {
        ...
        "title": "A manchete tem 6 pontos.",
        "title_em": "A eleição tem 30 em aberto.",
        "lede": "51 páginas publicadas, duas linhas lidas. Auditoria integral das outras 49: <b>mercado aberto, campo contra peso, piso de ruído e o vão</b>.",
        "stats": [
            ("30 pts", "de eleitorado em aberto"),
            ("12,05→6", "diferença em campo e publicada"),
            ("8", "perguntas não publicadas"),
        ],
