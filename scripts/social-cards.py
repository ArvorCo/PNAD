...
CARDS: list[dict] = [
    {
        ...
        "lede": "Doze auditorias de pesquisas eleitorais recalculadas contra a fonte oficial: <b>TSE</b> para o eleitorado, <b>IBGE/PNAD</b> para renda e escolaridade.",
        "stats": [
            ("12", "auditorias"),
            ("4", "institutos"),
    ...
    },
    {
        ...
        "lede": "Dezenove posts com a conta aberta: o vão de 7,43 pontos, os quatro cenários de segundo turno na mesma amostra e a faixa de renda que decide.",
        "stats": [
            ("19", "posts"),
            ("4", "cenários medidos"),
            ("114", "páginas lidas"),
